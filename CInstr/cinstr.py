...
class CInstrumentation:
    def __init__(self):
        ...
        self.appendInitFunction = "callAflProxyDll(%d);"#"//EFI_AFL_PROXY2_PROTOCOL *AflProxy2 = init_afl(%d);"
        self.appendFunctions = "callAflProxyDll(%d);"#"//AflProxy2->afl_maybe_log(%d);"
